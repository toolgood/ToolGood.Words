...
//        //  "！ !\r＂ \"\r＃ #\r＄ $\r％ %\r＆ &\r＇ '\r（ (\r） )\r＊ *\r＋ +\r， ,\r－ -\r． .\r／ /\r" +
//        //  ": :\r; ;\r< <\r= =\r> >\r? ?\r@ @\r[ [\r\\ \\\r] ]\r^ ^\r_ _\r` `\r{ {\r| |\r} }\r~ ~\r" +
//        //  "： :\r； ;\r＜ <\r＝ =\r＞ >\r？ ?\r＠ @\r［ [\r＼ \\\r］ ]\r＾ ^\r＿ _\r｀ `\r｛ {\r｜ |\r｝ }\r～ ~\r";
...
//        #region 私有变量
//        private bool _usedMiniPinyin = true;
//        private bool _usedPinyinAppend = true;
//        private bool _usedSpecialChar = false;//英文转数字 O=>0 o=>0 l=>1
//        private bool _removeOther;//删除字典外的文本。
...
//        /// 使用数字相近拼音，3500常用汉字
//        /// </summary>
//        public bool UsedMiniPinyin
//        {
//            get { return _usedMiniPinyin; }
//            set { _usedMiniPinyin = value; }
//        }
//        /// <summary>
//        /// 使用数字相近拼音,使用全部
//        /// </summary>
//        public bool UsedPinyinAppend
//        {
//            get { return _usedPinyinAppend; }
//            set { _usedPinyinAppend = value; }
//        }
//        /// <summary>
//        /// 使用英文转数字 O=>0 o=>0 l=>1
//        /// </summary>
//        public bool UsedSpecialChar
//        {
//            get { return _usedSpecialChar; }
//            set { _usedSpecialChar = value; }
//        }

//        /// <summary>
//        /// 删除字典外的文本
//        /// </summary>
//        public bool RemoveOtherWords
//        {
//            get { return _removeOther; }
//            set { _removeOther = value; }
//        }

//        /// <summary>
//        /// 最大跳跃长度，RemoveOtherWords为true时，可用
//        /// </summary>
//        public int MaxJump
//        {
//            get { return _maxJump; }
...
//                if (sp[1].Length == 1) {
//                    toWord[(int)sp[0][0]] = toSpecialChar(sp[1])[0];
//                } else {
//                    toWord[(int)sp[0][0]] = (char)1;
//                    toWordDict[sp[0][0]] = toSpecialChar(sp[1]);
//                }
//            }
//        }

//        private string toSpecialChar(string text)
//        {
//            if (_usedSpecialChar == false) return text;
