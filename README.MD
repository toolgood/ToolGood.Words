...
出售`整理后的敏感词库`和`《ToolGood 内容审核系统》`源码授权。

此敏感词库从70W多词组中整理出来的，敏感词分类齐全，并且内有18W多组常用分词、2W多字的拼音扩展、14066个左右拆字、4000组繁简转化，4850组同音同形字，1160组异形字……

有意的联系QQ：`1665690808`，非企业人员忽扰。
